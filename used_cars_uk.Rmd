...
Sin embargo, el análisis de la calidad de nuestro modelo mediante el RMSE (raíz de suma de minimos cuadrados) muestra un error (en euros) de 3705. Un error claramente muy elevado que nis indica la necesidad de refinar nuestro modelo.
